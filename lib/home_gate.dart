    ...
    return MultiProvider(
      providers: [
        ...
        Provider<FirebaseService>.value(
          value: firebaseService, // The instance created in AuthScreen is passed here.
        ),
        ...
        ChangeNotifierProvider(
          ...
          create: (_) => SubscriptionManager(firebaseService, appStatusNotifier),
          lazy: false, // Ensures IAP initialization starts immediately on entry.
        ),
      ],
