  ...
  WidgetsBinding.instance.addPostFrameCallback((_) async {
   ...
   if (user != null) {
    ...
    if (idToken != null && email != null) {
     ...
     setState(() { _stage = AuthLoadingStage.idle; });
    }
   } else {
    try {
     _googleSignIn
  ...
  return Scaffold(
   body: Stack(
    ...
    children: [
     ...
     if (!isLoading)
      Center( // Buttons are correctly centered here!
       child: Padding(
     ...
     if (showSpinner) ...[
      ...
      Padding(
       ...
       child: TweenAnimationBuilder<double>(
        ...
        duration: const Duration(milliseconds: 1000), // Increased to 1 second for smoothness
